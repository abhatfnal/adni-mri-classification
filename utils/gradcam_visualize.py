...
# csv_file = "/project/aereditato/cestari/adni-mri-classification/preprocessing/adni_preprocessed_npy_metadata.csv"

# idx_to_visualize = 321  # Change this to visualize a different subject
