function [normalized_mri_path, normalized_pet_path] = preprocess_pair(original_mri_path, pet_frames_dir)
    ...
    % Save masked images using prefixed filenames
    masked_mri_path = spm_file(bc_mri_vol.fname, 'prefix', 'masked_');
    masked_pet_path = spm_file(static_pet_vol.fname, 'prefix', 'masked_');
